 ...
 * limitations under the License.
 */
function H(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function q(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function $(){const e=H();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}class W extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,W.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,V.prototype.create)}}class V{create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?function(e,t){return e.replace(G,((e,n)=>{const r=t[n];return null!=r?String(r):`<${n}?>`}))}(i,n):"Error",s=`${this.serviceName}: ${o} (${r}).`;return new W(r,s,n)}constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}}const G=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ae=[];var ce,le;(le=ce||(ce={}))[le.DEBUG=0]="DEBUG",le[le.VERBOSE=1]="VERBOSE",le[le.INFO=2]="INFO",le[le.WARN=3]="WARN",le[le.ERROR=4]="ERROR",le[le.SILENT=5]="SILENT";const ue={debug:ce.DEBUG,verbose:ce.VERBOSE,info:ce.INFO,warn:ce.WARN,error:ce.ERROR,silent:ce.SILENT},he=ce.INFO,de={[ce.DEBUG]:"log",[ce.VERBOSE]:"log",[ce.INFO]:"info",[ce.WARN]:"warn",[ce.ERROR]:"error"},fe=(e,t,...n)=>{if(t<e.logLevel)return;const r=(new Date).toISOString(),i=de[t];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[i](`[${r}]  ${e.name}:`,...n)};class pe{get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ce))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?ue[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ce.DEBUG,...e),this._logHandler(this,ce.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ce.VERBOSE,...e),this._logHandler(this,ce.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ce.INFO,...e),this._logHandler(this,ce.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ce.WARN,...e),this._logHandler(this,ce.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ce.ERROR,...e),this._logHandler(this,ce.ERROR,...e)}constructor(e){this.name=e,this._logLevel=he,this._logHandler=fe,this._userLogHandler=null,ae.push(this)}}let me,ge;const ye=new WeakMap,ve=new WeakMap,be=new WeakMap,we=new WeakMap,_e=new WeakMap;let Ee={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return ve.get(e);if("objectStoreNames"===t)return e.objectStoreNames||be.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Te(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function Ie(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(ge||(ge=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(...t){return e.apply(ke(this),t),Te(ye.get(this))}:function(...t){return Te(e.apply(ke(this),t))}:function(t,...n){const r=e.call(ke(this),t,...n);return be.set(r,t.sort?t.sort():[t]),Te(r)}}function xe(e){return"function"==typeof e?Ie(e):(e instanceof IDBTransaction&&function(e){if(ve.has(e))return;const t=new Promise(((t,n)=>{const r=()=>{e.removeEventListener("complete",i),e.removeEventListener("error",o),e.removeEventListener("abort",o)},i=()=>{t(),r()},o=()=>{n(e.error||new DOMException("AbortError","AbortError")),r()};e.addEventListener("complete",i),e.addEventListener("error",o),e.addEventListener("abort",o)}));ve.set(e,t)}(e),t=e,(me||(me=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])).some((e=>t instanceof e))?new Proxy(e,Ee):e);var t}function Te(e){if(e instanceof IDBRequest)return function(e){const t=new Promise(((t,n)=>{const r=()=>{e.removeEventListener("success",i),e.removeEventListener("error",o)},i=()=>{t(Te(e.result)),r()},o=()=>{n(e.error),r()};e.addEventListener("success",i),e.addEventListener("error",o)}));return t.then((t=>{t instanceof IDBCursor&&ye.set(t,e)})).catch((()=>{})),_e.set(t,e),t}(e);if(we.has(e))return we.get(e);const t=xe(e);return t!==e&&(we.set(e,t),_e.set(t,e)),t}const ke=e=>_e.get(e);function Se(e,t,{blocked:n,upgrade:r,blocking:i,terminated:o}={}){const s=indexedDB.open(e,t),a=Te(s);return r&&s.addEventListener("upgradeneeded",(e=>{r(Te(s.result),e.oldVersion,e.newVersion,Te(s.transaction))})),n&&s.addEventListener("blocked",(()=>n())),a.then((e=>{o&&e.addEventListener("close",(()=>o())),i&&e.addEventListener("versionchange",(()=>i()))})).catch((()=>{})),a}const Ne=["get","getKey","getAll","getAllKeys","count"],Ae=["put","add","delete","clear"],Oe=new Map;function Re(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if(Oe.get(t))return Oe.get(t);const n=t.replace(/FromIndex$/,""),r=t!==n,i=Ae.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!i&&!Ne.includes(n))return;const o=async function(e,...t){const o=this.transaction(e,i?"readwrite":"readonly");let s=o.store;return r&&(s=s.index(t.shift())),(await Promise.all([s[n](...t),i&&o.done]))[0]};return Oe.set(t,o),o}Ee=(e=>({...e,get:(t,n,r)=>Re(t,n)||e.get(t,n,r),has:(t,n)=>!!Re(t,n)||e.has(t,n)}))(Ee);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(e="[DEFAULT]"){const t=De.get(e);if(!t)throw je.create("no-app",{appName:e});return t}function qe(e,t,n){var r;let i=null!==(r=Pe[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const o=i.match(/\s|\//),s=t.match(/\s|\//);if(o||s){const e=[`Unable to register library "${i}" with version "${t}":`];return o&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&s&&e.push("and"),s&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ce.warn(e.join(" "))}Ue(new ie(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}let $e=null;function We(){return $e||($e=Se("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw je.create("idb-open",{originalErrorMessage:e.message})}))),$e}async function Ve(e,t){var n;try{const n=(await We()).transaction("firebase-heartbeat-store","readwrite"),r=n.objectStore("firebase-heartbeat-store");return await r.put(t,Ge(e)),n.done}catch(e){if(e instanceof W)Ce.warn(e.message);else{const t=je.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});Ce.warn(t.message)}}}function Ge(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Qe;Qe="",Ue(new ie("platform-logger",(e=>new Le(e)),"PRIVATE")),Ue(new ie("heartbeat",(e=>new Ke(e)),"PRIVATE")),qe("@firebase/app","0.7.31",Qe),qe("@firebase/app","0.7.31","esm2017"),qe("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yt(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(mt()||q()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(e){return 1e3*Number(e)}function Lt(e){var t;const[n,r,i]=e.split(".");if(void 0===n||void 0===r||void 0===i)return it("JWT malformed, contained fewer than 3 sections"),null;try{const e=j(r);return e?JSON.parse(e):(it("Failed to decode base64 JWT payload"),null)}catch(e){return it("Caught error parsing JWT payload as JSON",null===(t=e)||void 0===t?void 0:t.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $t(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Kt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Wt(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Xt(t))return"Blackberry";if(Yt(t))return"Webos";if(Vt(t))return"Safari";if((t.includes("chrome/")||Gt(t))&&!t.includes("edge/"))return"Chrome";if(Jt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Wt(e=H()){return/firefox\//i.test(e)}function Vt(e=H()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Gt(e=H()){return/crios\//i.test(e)}function Kt(e=H()){return/iemobile/i.test(e)}function Jt(e=H()){return/android/i.test(e)}function Xt(e=H()){return/blackberry/i.test(e)}function Yt(e=H()){return/webos/i.test(e)}function Qt(e=H()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Zt(){return $()&&10===document.documentMode}function en(e=H()){return Qt(e)||Jt(e)||Yt(e)||Xt(e)||/windows phone/i.test(e)||Kt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function tn(e,t=[]){let n;switch(e){case"Browser":n=$t(H());break;case"Worker":n=`${$t(H())}-${e}`;break;default:n=e}return`${n}/JsCore/9.9.3/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(e,t){return kt(e,"POST","/v1/accounts:signInWithPassword",It(e,t))}(e,{returnSecureToken:!0,email:this._email,password:this._password});case"emailLink":
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(e,t){return kt(e,"POST","/v1/accounts:signInWithIdp",It(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function En(e,t){return kt(e,"POST","/v1/accounts:signUp",It(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function An(e,t,n=!1){const r="signIn",i=await kn(e,r,t),o=await In._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(o.user),o}async function On(e,t){return An(on(e),t)}async function Rn(e,t,n){const r=on(e),i=await En(r,{returnSecureToken:!0,email:t,password:n}),o=await In._fromIdTokenResponse(r,"signIn",i);return await r._updateCurrentUser(o.user),o}function Ln(e){return re(e).signOut()}new WeakMap;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=new vt(5e3,15e3),kr={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Sr=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Nr(e){const t=e.config;lt(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?bt(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:"9.9.3"},i=Sr.get(e.config.apiHost);i&&(r.eid=i);const o=e._getFrameworks();return o.length&&(r.fw=o.join(",")),`${n}?${Y(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=new pe("@firebase/firestore");function $r(e,...t){if(qr.logLevel<=ce.DEBUG){const n=t.map(Vr);qr.debug(`Firestore (${Hr}): ${e}`,...n)}}function Wr(e,...t){if(qr.logLevel<=ce.ERROR){const n=t.map(Vr);qr.error(`Firestore (${Hr}): ${e}`,...n)}}function Vr(e){if("string"==typeof e)return e;try{return t=e,JSON.stringify(t)}catch(t){return e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=He()){const t=Fe(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Fe(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(J(n.getOptions(),null!=t?t:{}))return e;ot(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Cr,persistence:[Jn,Dn,Mn]})}(Ti));function Si(){var e,t,n;e=e=>{e?_i.classList.remove("is-hidden-logout"):(vi.classList.contains("current")&&(bi.classList.remove("auth-form-hidden"),document.body.classList.toggle("body-overflow")),console.log("no user"))},re(ki).onAuthStateChanged(e,t,n)}function Ni(){const e=document.querySelector(".auth-form-mail"),t=document.querySelector(".auth-form-password");e.value="",t.value=""}Si(),Ii.addEventListener("click",(async function(e){e.preventDefault();const t=Ei.elements.mail.value,n=Ei.elements.password.value;try{const e=await(r=ki,i=t,o=n,On(re(r),mn.credential(i,o)));_i.classList.remove("is-hidden-logout"),bi.classList.add("auth-form-hidden"),document.body.classList.toggle("body-overflow"),console.log(e.user),Ur.Notify.success("successful",jr),Ni()}catch(e){Ur.Notify.failure(`${e.message}`,jr)}var r,i,o;
/**
 * @license
 * Copyright 2020 Google LLC
 *
